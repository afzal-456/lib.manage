...
int main() {
    ...
    struct Book initialBooks[] = {
        {1, "Effective Java", "Joshua Bloch", 5},
        {2, "The Pragmatic Programmer", "Andrew Hunt", 8},
        {3, "Python Crash Course", "Eric Matthes", 10},
    };

    int numInitialBooks = sizeof(initialBooks) / sizeof(initialBooks[0]);
